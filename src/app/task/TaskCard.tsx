  ...
  return (
    <>
      <div
        ...
        className={`relative rounded-2xl border group border-solid transition-colors ${isDragged ? "border-gray-d0-500/10" : "border-gray-d0-500/50 hover:border-gray-d0-500"}`}
      >
        <button
          onClick={handleOpenContent}
          className="flex flex-col md:p-4 p-2 w-full"
        >
      ...
      <TaskModal action='update' open={openContent} task={task} onClose={handleCloseContent} />
    </>
  );
};
