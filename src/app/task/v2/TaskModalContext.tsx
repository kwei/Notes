			...
			>
				{task && (
					<form className="flex h-full flex-col md:h-auto" onSubmit={saveTask}>
						...
						<div
							className="flex w-full flex-col divide-y divide-gray-500 rounded-sm border border-solid border-gray-500">
                ...
                <span
                  ...
                  Delete
								...
								{deleting && (
									<span
										className="absolute size-3 animate-spin rounded-full border-2 border-solid border-gray-d0-500 border-l-transparent"></span>
								)}
							</button>
                  ...
                  <span
                    ...
                    Save Task
									...
									{saving && (
										<span
											className="absolute size-3 animate-spin rounded-full border-2 border-solid border-gray-700 border-l-transparent"></span>
									)}
								</button>
							</div>
						</div>
...
const Comments = ({comments = []}: { comments?: IMsgLog[] }) => {
	...
	return (
		<div className="flex w-full flex-col gap-2 pt-4">
			<div
				className="flex w-full items-center gap-1 divide-x divide-gray-500 rounded-sm border border-solid border-gray-500">
				<input
					ref={ref}
					type="text"
