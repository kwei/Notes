...
export const MONGODB_SPENDING_URI = `mongodb+srv://${process.env.MONGODB_USERNAME}:${process.env.MONGODB_PASSWORD}@spending.kfp56hq.mongodb.net/?retryWrites=true&w=majority&appName=Spending`;
